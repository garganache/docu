...
The datasets can be found :download:`here<downloadable_docs/DataSets.zip>`.
...
This is in fact what is happening in the :ref:`e2e_example`.

*************************************************
Model assessment including representativeness
*************************************************

In this example you will add another step as compared to the basic workflow. Specifically, we will calculate some preliminary metrics on the train dataset and store those inside a :term:`Artifact`.
...
.. figure:: figs/Validation_Binary_Medium_workflow.png
    :width: 100%
    :align: center
    :alt: Yields for Performance workflow

All relevant files are stored here: :download:`click here to download<downloadable_docs/Binary_Target_Medium_Assessment.zip>`.
...
.. figure:: figs/Validation_Binary_Full_workflow.png
    :width: 100%
    :align: center
    :alt: Yields for Performance workflow

All relevant files are stored here: :download:`click here to download<downloadable_docs/Binary_Target_Full_Assessment.zip>`.
...
.. note::
    ...
    .. figure:: figs/Validation_Binary_Full_workflow_ALTERNATIVE.png
        :width: 100%
        :align: center
        :alt: Yields for Performance workflow
...
We will save a data quality dictionary, as well as an enriched dataset with additional outlier information. The latter can be used fo example to conduct a model performance analysis on the inliers/outliers (see :ref:`vanilla_assessment`).

.. figure:: figs/Workflow_Outlier_DQ.png
    :width: 100%
    :align: center
    :alt: Workflow_Outlier_DQ

All relevant files are stored here: :download:`click here to download<downloadable_docs/DataQuality.zip>`.
...
.. figure:: figs/XAI_workflow.png
    :width: 100%
    :align: center
    :alt: Workflow_XAI

All relevant files are stored here: :download:`click here to download<downloadable_docs/XAI.zip>`.
